              ...
              <div className='m-stack__item m-stack__item--fluid'>
                <div className='m-login__wrapper'>
                  <div className='m-login__signup'>
                    ...
                    <form onSubmit={this.props.onSubmit} className='m-login__form m-form'>
                      <div id='email-error' style={{color: 'red', fontWeight: 'bold'}}><bold>error</bold></div>
                      ...
                      <div className='form-group m-form__group'>
                        <input className='form-control m-input' type='text' placeholder='Email' ref='name' required style={{ WebkitBoxShadow: 'none', boxShadow: 'none', height: '45px' }} />
                      </div>
                      <div className='form-group m-form__group'>
                      ...
                      <div className='form-group m-form__group'>
                        ...
                        { this.props.password && this.props.pwdlength === false &&
